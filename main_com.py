        ...
        if config.learn_mode:
            ...
            try:
                ...
                for objectN in range(len(omigas)):
                    ...
                    with open(config.save_to + "duration_com.txt", "a+") as f:
            ...
            for objectN in range(len(omigas)):
                ...
                print("{}_{}/".format(config.load_from, i + 1) + objectiveModel + "/model.ckpt", " 's Model restored.")
                # print_trainable_parameters()
            ...
            for batchN in range(config.batch_size):
                ...
                # HV
                #hv[batchN] = mobj.get_hyperVolume([550, 100])  #当vnf = 6 8 10   0805之前参数
